...
# 📖 Grocery_Backend <a name="about-project"></a>

A Backend application built with node.JS and Express that allows users to see grocery-product list and add to their shopping cart.
...
Clone this repository to your desired folder:
  ...
  - cd my-folder
  - git clone https://github.com/massazoum/grocery-backend-node.js.git
